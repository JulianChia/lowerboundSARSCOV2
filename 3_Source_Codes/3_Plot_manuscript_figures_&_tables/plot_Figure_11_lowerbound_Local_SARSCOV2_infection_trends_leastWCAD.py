...
def plot_SARSCoV2_curves(WCADS):
    fontsize_axis = 16
    ...
    def add_circuit_breaker(ax, subplot):
        ...
        # Boundary
        rect = Rectangle((cb_start, 0), width, 2150, linewidth=0,
    ...
    def add_zoom_region(ax, xdates, ye, yp):
        ...
        axins.bar(xdates, yp, color='C6', alpha=0.5)
    ...
    bottom = 0.080  # the bottom of the subplots of the figure
